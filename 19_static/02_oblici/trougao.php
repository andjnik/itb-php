...
$trougao = new Trougao(7, 6, 8);
echo "Stranice trougla: " . $trougao->getA() . ", " . $trougao->getB() . ", " . $trougao->getC() . "<br>";
echo "Obim trougla: " . $trougao->obimTrougla() . "<br>";
echo "Površina trougla: " . $trougao->povrsinaTrougla() . "<br>";
