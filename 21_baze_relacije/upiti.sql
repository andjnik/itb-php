...
-- zbog AUTO_INCREMET nismo u obavezi da navodimo id prilikom inserta sam dodaje
INSERT INTO `kategorije` (`naziv`) VALUES
('Ljubav'),
('Drustvo'),
('Zdravlje');

CREATE TABLE `kategorija_has_objave` (
    `kategorija_id` INT(10) UNSIGNED NOT NULL, -- FK NE MOZE DA SE DODA JER TIP POLJA MORA DA BUDE ISTI KAO kategorije(id)
    `objava_id` INT NOT NULL
) ENGINE=INNODB;
...
ALTER TABlE `kategorije_das_objave`
