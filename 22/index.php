                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php
                                if($res->num_rows==0) {
                                    ...
                                    while($row = $res->fetch_assoc()) { //$row je jedan red iz baze u obliku ['id'=>1, 'ime'=>'Elizabeta', 'prezime'=>'Markus', ...]
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- u sva tri linka saljemo ID studenta get metodama tj putem linka da bi mogli da pokupimo taj podatak i znamo o kom studentu se radi -->
