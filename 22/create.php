...
// pravimo niz u kome smestamo poruke o nevalidnoj popunjenoj formi
$errMsg=[];
$ime = $prezime = $email = $broj_telefona = "";

// proveravamo da li smo na sranicu dosli POST metodom
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(count($errMsg) == 0) {
        $q = "INSERT INTO `studenti` (`ime`, `prezime`, `email`, `broj_telefona`)
        VALUES ('" . $ime . "', '" . $prezime . "', '" . ($email?$email:null). "', '" . ($broj_telefona?$broj_telefona:null) . "');";
                    ...
                    <div class="card-body">
                        <form action="#" method="post"> <!-- forma salje podatke istoj stranici POST metodom -->
                            <div class="form-group mb-3">
                                ...
                                value="<?php echo $ime;?>"> <!-- vrednost atributa NAME mora da bude jedinstveno na nivo forme jer je to kljuc u asocijativnom nizu kada se preuzmu parametri -->
                            ...
                            <div class="float-end mb-3">
                                <button type="submit" class="btn btn-success"> Sacuvaj </button> <!-- Unutar forme mora da imamo submit dugme na ciji se klik zapravo salju podaci -->
